...
func (r *userR) GetTeamMembers() TeamMemberSlice {
	if r == nil {
		return nil
	}
...
func (o *User) TeamMembers(mods ...qm.QueryMod) teamMemberQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"team_member\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadTeamMembers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`team_member`),
		qm.WhereIn(`team_member.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddTeamMembers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TeamMember) error {
	var err error
...
// Sets o.R.User's TeamMembers accordingly.
// Replaces o.R.TeamMembers with related.
// Sets related.R.User's TeamMembers accordingly.
func (o *User) SetTeamMembers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TeamMember) error {
	query := "update \"team_member\" set \"user_id\" = null where \"user_id\" = $1"
...
// Sets related.R.User.
func (o *User) RemoveTeamMembers(ctx context.Context, exec boil.ContextExecutor, related ...*TeamMember) error {
	if len(related) == 0 {
		return nil
	}
